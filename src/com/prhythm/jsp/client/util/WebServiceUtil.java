...
public class WebServiceUtil {
    ...
    static WebServiceClient.Credential defaultCredential;

    public static void registerClient(WebServiceClient client) {
        WebServiceUtil.client = client;
    }

    public static WebServiceClient getDefaultClient() {
        return client;
    }

    public static void setDefaultCredential(WebServiceClient.Credential defaultCredential) {
        WebServiceUtil.defaultCredential = defaultCredential;
    }

    public static WebServiceClient.WebServiceResponse execute(String url, String soapEntity) {
        if (client == null) {
            throw new NotImplementedException();
        } else {
            if (defaultCredential == null) {
                return client.execute(url, soapEntity);
            } else {
                return client.execute(url, soapEntity, defaultCredential.userName, defaultCredential.password, defaultCredential.domain);
            }
        }
    }

    public static WebServiceClient.WebServiceResponse execute(String url, String soapEntity, String userName, String password, String domain) {
        if (client == null) {
            throw new NotImplementedException();
        } else {
            return client.execute(url, soapEntity, userName, password, domain);
        }
    }
